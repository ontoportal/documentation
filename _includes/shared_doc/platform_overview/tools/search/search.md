...
Search can be done using the API directly. To learn more, see our [Search REST API documentation]({{ site.baseurl }}{% link docs/users-guide-docs/documentation/{{page.sportal}}/developer_guide/api_key.md %}).
