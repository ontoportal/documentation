...
Logged in users can navigate to the [Browse page]({{page.url}}ontologies) and click the [Submit a {{page.atom}}]({{page.url}}ontologies/new) button. The submission form requires to fill out some [metadata]({{ site.baseurl }}{% link docs/users-guide-docs/documentation/{{page.sportal}}/metadata_schema.md %}) about the submitted {{page.atom}} as shown in Figure 43:
