...
From this section, located at the top right corner (see Figure 45.1), the {{page.atom}} manager(s) can upload a new version of the existing {{page.atom}} and update the metadata using one of the following two options:
