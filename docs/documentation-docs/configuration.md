...
See [the Code documentation]({{ site.baseurl }}{% link docs/documentation-docs/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({{ site.baseurl }}{% link docs/documentation-docs/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({{ site.baseurl }}{% link docs/documentation-docs/customization.md %}) for more information.
...
See [Callouts]({{ site.baseurl }}{% link docs/documentation-docs/ui-components/callouts.md %}) for more information.
